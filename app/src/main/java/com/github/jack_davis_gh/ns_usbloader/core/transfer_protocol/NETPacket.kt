...
import com.github.jack_davis_gh.ns_usbloader.BuildConfig
...
object NETPacket {
    private const val CODE_200 = "HTTP/1.0 200 OK\r\n" +
    ...
    private const val CODE_206 = "HTTP/1.0 206 Partial Content\r\n" +
            "Server: NS-USBloader-M-v." + BuildConfig.VERSION_NAME + "\r\n" +
            "Date: %s\r\n" +
            "Content-type: application/octet-stream\r\n" +
            "Accept-Ranges: bytes\r\n" +
            ...
            "Content-Length: %d\r\n" +
            "Last-Modified: Thu, 01 Jan 1970 00:00:00 GMT\r\n\r\n"
    private const val CODE_400 = "HTTP/1.0 400 invalid range\r\n" +
            "Server: NS-USBloader-M-v." + BuildConfig.VERSION_NAME + "\r\n" +
            "Date: %s\r\n" +
            "Connection: close\r\n" +
            "Content-Type: text/html;charset=utf-8\r\n" +
            "Content-Length: 0\r\n\r\n"
    private const val CODE_404 = "HTTP/1.0 404 Not Found\r\n" +
            "Server: NS-USBloader-M-v." + BuildConfig.VERSION_NAME + "\r\n" +
            "Date: %s\r\n" +
            "Connection: close\r\n" +
            "Content-Type: text/html;charset=utf-8\r\n" +
            "Content-Length: 0\r\n\r\n"
    private const val CODE_416 = "HTTP/1.0 416 Requested Range Not Satisfiable\r\n" +
            "Server: NS-USBloader-M-v." + BuildConfig.VERSION_NAME + "\r\n" +
            "Date: %s\r\n" +
            "Connection: close\r\n" +
            "Content-Type: text/html;charset=utf-8\r\n" +
